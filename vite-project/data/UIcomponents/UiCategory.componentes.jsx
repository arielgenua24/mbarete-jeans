...
export const categoryComponents = {
  Nuevos: <Category filter={"Nuevos"} onNavigate={handleNavigate} />,
  ...
  PocoStock: <Category filter={"PocoStock"} onNavigate={handleNavigate} />,
  ...
  Camperas: <Category filter={"Camperas"} onNavigate={handleNavigate} />,
  Chalecos: <Category filter={"Chalecos"} onNavigate={handleNavigate} />,
};
